...
// Per-contact purchase count, total + biggest amount, and first/last
// dates, scoped to the given organization's purchases.
export function purchaseSignals(organizationId) {
