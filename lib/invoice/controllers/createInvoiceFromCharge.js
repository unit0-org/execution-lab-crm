...
import { chargeInvoiceCode } from './chargeInvoiceCode'
...
// Create a draft invoice for a stored Stripe purchase, at most once.
export async function createInvoiceFromCharge(organizationId, purchase) {
  ...
  const number = chargeInvoiceCode(purchase)
