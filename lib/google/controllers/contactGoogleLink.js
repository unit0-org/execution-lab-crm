...
// link on the primary account; null when the contact isn't linked. The
// email is the owning account, so the web link opens under it.
export async function contactGoogleLink(contactId) {
