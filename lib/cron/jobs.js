...
import {
  sendPendingPaymentFollowups, chargeDueInstallments,
...
export const CRON_JOBS = [
  ...
  { name: 'reservation-reminders',
    label: 'Warn reserved seats about to lapse',
    run: sendReservationReminders },
  { name: 'charge-installments',
    label: 'Charge due payment plans', run: chargeDueInstallments },
  { name: 'weekly-digest',
