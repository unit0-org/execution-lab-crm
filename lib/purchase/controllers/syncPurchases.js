...
// Backfill Stripe charges, throttled to once a day unless forced.
// Returns counts plus the latest sync time for the UI.
export async function syncPurchases(force) {
  ...
  const counts = await backfillCharges()
