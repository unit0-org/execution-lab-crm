...
// rows to the meeting (meta.factDate) rather than today. Returns count added.
export async function addFactsTx(contactId, facts, t, meta) {
  const factDate = meta?.factDate
  let added = 0
