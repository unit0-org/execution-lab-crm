...
export async function applyContactAdds(contactId, add, t, factDate) {
  const a = add || {}
  ...
  return {
    ...
    facts: await addFactsTx(contactId, a.facts, t, factDate),
    contactNotes: await addContactNotesTx(contactId, a.notes, t)
  }
}
