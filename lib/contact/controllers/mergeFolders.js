...
export const FOLDERS = [
  ...
  mergeEmails, mergePhones, mergeCategoryLinks, mergeRelationships,
  mergePortalMembers, mergeToolAccess, mergeEmailMessages, mergeContactFiles,
  claimContactRecords, foldOfferCollab
]
