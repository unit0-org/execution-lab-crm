...
import { OfferGeneratorInput } from '@/lib/offerGenerator/models'
import { claimRows } from './claimRows'

const OWNED = [
  ContactNote, ContactFact, Purchase, Invoice, Registration, WaitlistEntry,
  NoteMention, Notification, OfferGeneratorInput
]
...
// notifications and offer-generator inputs. None are unique per contact, so
// a straight move is safe.
