...
export const INSTRUCTIONS = `Execution Lab CRM. Glossary and conventions:
...
- Fact (a.k.a. nugget): a manually recorded note on a contact — an
  optional label (a question) and a value (the answer).
