...
import { CohortFolder } from '../../cohort/models/CohortFolder'
import { CohortResource } from '../../cohort/models/CohortResource'
import { Registration } from './Registration'
import { RegistrationInstallment } from './RegistrationInstallment'
...
const models = {
  Contact, Cohort, CohortFolder, CohortResource, Registration,
  RegistrationInstallment, WaitlistEntry
}

Cohort.associate(models)
CohortFolder.associate(models)
CohortResource.associate(models)
Registration.associate(models)
RegistrationInstallment.associate(models)
WaitlistEntry.associate(models)

export {
  Cohort, CohortFolder, CohortResource, Registration,
  RegistrationInstallment, WaitlistEntry
}
