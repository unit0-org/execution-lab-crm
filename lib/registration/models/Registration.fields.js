...
const { UUID, UUIDV4, TEXT, INTEGER, DATE, BOOLEAN } = DataTypes
...
export const fields = {
  ...
  email, phone: TEXT, company: TEXT, role: TEXT,
  ...
  payment_plan: { type: BOOLEAN, defaultValue: false },
  created_at: { type: DATE, defaultValue: DataTypes.NOW },
  paid_at: DATE, payment_followup_sent_at: DATE,
  reserved_at: DATE, reservation_reminder_sent_at: DATE
}
