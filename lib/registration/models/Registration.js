...
Registration.associate = ({ Cohort, Contact, RegistrationInstallment }) => {
  ...
  Registration.hasMany(RegistrationInstallment, {
    foreignKey: 'registration_id', as: 'installment', onDelete: 'CASCADE'
  })
}
