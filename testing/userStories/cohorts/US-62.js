const userStory = {
  ...
  behaviours: [
    ...
    'The terms are stated before I pay: amount today, amount and date ' +
      'of the second charge, same card.',
    ...
    'The balance is the price less everything Stripe captured, so a ' +
      'refund or partial payment never makes it wrong.',
