...
import { CohortRegistrants } from './CohortRegistrants'
...
export function CohortDetailView({ cohort, registrations, folders, contacts }) {
  return (
    <Stack gap="lg">
      ...
      <CohortRegistrants cohortId={cohort.id} registrations={registrations}
        contacts={contacts} />
