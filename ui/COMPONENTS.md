...
| `Collapsible` | `title`, `preview`, `defaultOpen=true`, `children` | Expand/collapse section; `preview` shows only while collapsed. Native `<details>` owns the open state — no JS. |
